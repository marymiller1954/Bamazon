...
console.log('------------------------------------------------');
console.log('Bamazon for Product Managers');
console.log('------------------------------------------------\n');
...
var appStart = function() {
        ...
        choices:['View Products for Sale', 'View Low Inventory', 'Add to Inventory', 'Add New Product', 'Exit']
            ...
            switch(answer.Menu) {
                ...
                case 'Add New Product':
                    ...
                    break;
                case 'Exit':
                    console.log("Have a Nice Day! Thank you for using Bamazon Manager!");
                    connection.end();
            } // end of switch
    ...
    function newProduct() {
        inquirer.prompt([{
            name: "product",
            type: "input",
            message: "Enter the name of the Product you want to add to Bamazon"
        }, {
            name: "department",
            type: "input",
            message: "Enter the Department name of the Product you want to add to Bamazon"
        }, {
            name: "price",
            type: "input",
            ...
            name: "quantity",
            type: "input",
            message: "Enter the amount of items you want to add to the inventory"
